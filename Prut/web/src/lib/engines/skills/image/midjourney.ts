...
export const skill: PlatformSkill = {
  ...
  refinementExamples: [
    {
      iteration: 1,
      beforePrompt: "A cat on a roof, sunset, nice view, beautiful, detailed, 8k --ar 16:9",
      afterPrompt:
    ...
    {
      iteration: 2,
      beforePrompt: "Coffee shop in Paris, woman reading, cozy, cinematic --ar 3:2 --s 400",
      afterPrompt:
