...
export const skill: PlatformSkill = {
  ...
  refinementExamples: [
    {
      iteration: 1,
      beforePrompt: "Astronaut on Mars, cool, cinematic [aspectRatio: 16:9]",
      afterPrompt:
    ...
    {
      iteration: 2,
      beforePrompt: "Bowl of ramen, food photo",
      afterPrompt:
      ...
      changes: ["Named ingredients, angle, steam behavior, and surface styling"],
    },
  ],
};
