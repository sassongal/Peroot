...
export const skill: PlatformSkill = {
  ...
  refinementExamples: [
    {
      iteration: 1,
      beforePrompt: "A dancer spins, fast, stage, lights",
      afterPrompt:
      ...
      changes: ["Beat structure + garment physics; specified lighting and shot size"],
    },
    {
      iteration: 2,
      beforePrompt: "Dragon flies over castle",
      afterPrompt:
      ...
      changes: ["Added scale layers, light direction, and negative artifact list"],
    },
  ],
};
