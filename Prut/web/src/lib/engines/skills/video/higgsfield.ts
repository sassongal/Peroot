...
Single warm spotlight with theatrical haze, deep shadows around the stage, old-world magic show ambiance, 50mm. Total: 4s.`,
  ...
  chainOfThoughtExamples: [
    ...
    },
    {
      ...
      reasoning: "Motion must sync braking: tire smoke, body pitch, camera shake subtle.",
      output:
  ...
  refinementExamples: [
    {
      iteration: 1,
      beforePrompt: "[Camera] shot [Subject] man [Motion] walks",
      afterPrompt:
      ...
      changes: ["Exploded vague placeholders into timed motion with wardrobe + prop detail"],
    },
    {
      iteration: 2,
      beforePrompt: "[Motion] dances",
      afterPrompt:
      ...
      changes: ["Replaced single verb with beat-timed choreography + camera reveal"],
    },
  ],
};
