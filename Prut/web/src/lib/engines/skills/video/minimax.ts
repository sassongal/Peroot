...
export const skill: PlatformSkill = {
  ...
  chainOfThoughtExamples: [
    ...
    },
    {
      ...
      reasoning: "Tracking shot + athletic physics: approach foot, arm swing, landing compression.",
      output:
  ...
  refinementExamples: [
    {
      iteration: 1,
      beforePrompt: "[Pan] A guy is nervous in a room.",
      afterPrompt:
      ...
      changes: ['Chose static vs vague pan; replaced "nervous" with four micro-actions'],
    },
    {
      iteration: 2,
      beforePrompt: "[Shake] explosion",
      afterPrompt:
      ...
      changes: ["Linked shake to impact physics + environmental debris timing"],
    },
  ],
};
