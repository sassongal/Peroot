...
Music: "solo piano, Satie-like simplicity, sparse Gymnopedies-style notes with long sustain."`,
  ...
  refinementExamples: [
    {
      iteration: 1,
      beforePrompt: "Beach at sunset. Audio: waves.",
      afterPrompt:
      ...
      changes: ["Expanded SFX/ambient; music tied to emotion; richer visual grounding"],
    },
    {
      iteration: 2,
      beforePrompt: "Office argument. Loud.",
      afterPrompt:
      ...
      changes: ['Specific dialogue beat; SFX tied to props; removed vague "loud"'],
    },
  ],
};
