...
export const IMAGE_PLATFORMS: ImagePlatformConfig[] = [
  ...
  { id: 'dalle', name: 'DALL-E 3', nameHe: 'DALL-E 3', description: 'שפה טבעית, תיאורים עשירים', supportsNegativePrompt: false, supportsJson: false, promptStyle: 'natural', icon: 'dalle' },
  { id: 'flux', name: 'Flux', nameHe: 'Flux', description: 'שפה טבעית, תמיכה בצבעי hex', supportsNegativePrompt: false, supportsJson: false, promptStyle: 'natural', icon: 'flux' },
  ...
  { id: 'imagen', name: 'Imagen', nameHe: 'Imagen', description: 'תיאור נרטיבי, עד 480 טוקנים', supportsNegativePrompt: true, supportsJson: false, promptStyle: 'narrative', icon: 'imagen' },
