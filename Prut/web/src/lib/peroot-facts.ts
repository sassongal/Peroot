...
const FACTS_HE: readonly string[] = [
  ...
  `בספריית פירוט יש מעל ${PROMPT_LIBRARY_COUNT} פרומפטים מקצועיים מוכנים בעברית, לכל תחום.`,
  ...
  "משתמשי פירוט Pro מקבלים מכסה חודשית בלי מגבלה יומית, את כל המצבים המתקדמים, והעתקה בלי חתימת Peroot.",
...
const FACTS_EN: readonly string[] = [
  ...
  `Peroot's library has ${PROMPT_LIBRARY_COUNT} professional prompts ready to use, across every domain.`,
