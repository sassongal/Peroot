      ...
      <div className="flex items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-(--text-muted) mt-1">
            שישה מקרים בארבע שפות דרך המנוע האמיתי, נמדדים בשופט-AI (שטף, נאמנות, מבנה) ובמדרג
            של פירוט. רץ אוטומטית בכל יום ראשון. היעד: ערבית ורוסית בטווח 0.5 מעברית בשופט ו-5 במדרג.
          </p>
        </div>
