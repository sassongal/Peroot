...
function isVisualEngineMode(mode: string): boolean {
  ...
  return m === CapabilityMode.IMAGE_GENERATION || m === CapabilityMode.VIDEO_GENERATION;
}
              ...
              <div className="relative p-10 rounded-[38px] bg-zinc-950 flex flex-col gap-10 h-full">
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex flex-col items-end gap-3">
                    ...
                    <span className="text-[9px] font-black text-zinc-800 uppercase tracking-tighter decoration-zinc-800 underline-offset-4 underline">
          ...
          <div className="flex items-center justify-between relative">
            <div className="flex items-center gap-8">
              ...
              <div>
                ...
                <p className="text-[10px] text-zinc-600 font-black uppercase tracking-[0.3em]">
                  Cross-engine throughput analysis
                </p>
              </div>
            </div>
            <div className="flex items-center gap-12">
              ...
              <div className="text-right">
                ...
                <div className="h-2 w-48 bg-white/5 rounded-full overflow-hidden">
                  <div
                    className="h-full bg-indigo-600 shadow-[0_0_10px_rgba(147,51,234,0.3)] transition-all duration-700"
