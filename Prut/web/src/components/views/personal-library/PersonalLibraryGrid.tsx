    ...
    <main className="flex-1 min-w-0 space-y-4">
              ...
              >
                <div className="flex justify-between items-start gap-2">
                  ...
                  <button
                    ...
                    className="shrink-0 focus-visible:ring-2 focus-visible:ring-amber-500/50 focus-visible:outline-none rounded"
                  >
                    <Star className="w-4 h-4 text-yellow-300 fill-yellow-300" />
                  </button>
                </div>
                <p className="text-xs text-(--text-muted) line-clamp-2" dir="rtl">
                  {p.use_case}
                </p>
                <div className="flex gap-2">
                  <button
                    onClick={() => onUsePrompt(p)}
                    className="flex-1 bg-white text-black py-1.5 rounded text-xs font-bold focus-visible:ring-2 focus-visible:ring-amber-500/50 focus-visible:outline-none"
                  >
                    השתמש
                  </button>
                  <button
                    onClick={() => addPersonalPromptFromLibrary(p)}
                    className="flex-1 border border-(--glass-border) text-(--text-secondary) py-1.5 rounded text-xs focus-visible:ring-2 focus-visible:ring-amber-500/50 focus-visible:outline-none"
                  >
                    שמור עותק
                  </button>
                </div>
      ...
      <div className="space-y-1.5">
        ...
        {!isLoading &&
          ...
          selectedCapabilityFilter && (
            <div
              className="mx-2 text-center py-10 rounded-xl border border-amber-500/15 bg-amber-500/4"
              dir="rtl"
            >
              <Filter className="w-6 h-6 text-amber-500/50 mx-auto mb-2" />
              <p className="text-(--text-muted) text-sm font-medium">
                אין פרומפטים עם הפילטר הנוכחי
              </p>
              <button
            ...
            onDrop={(e) =>
              handlePersonalDropToEnd(
                ...
                effectiveFolder === "all"
                  ...
                  : (effectiveFolder ?? PERSONAL_DEFAULT_CATEGORY),
              )
            }
          >
