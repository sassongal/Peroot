    ...
    return (
      <>
        ...
        <div
          ...
          aria-label="היסטוריה"
          className={cn(
            "fixed start-0 z-60 bg-white/95 dark:bg-black/95 backdrop-blur-xl border-e border-black/10 dark:border-white/10 flex flex-col transition-all duration-300 ease-out",
            ...
            <button
              ...
              className={cn(
                ...
                personalView === "favorites"
                  ? "bg-amber-500/20 text-amber-600 dark:text-amber-300 border-amber-400/50"
