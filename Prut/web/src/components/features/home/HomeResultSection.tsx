...
const SmartRefinement = dynamic(
  () =>
    import("@/components/features/prompt-improver/SmartRefinement").then(
      (mod) => mod.SmartRefinement,
    ),
  {
    ssr: false,
    loading: () => <div className="animate-pulse rounded-xl bg-[var(--glass-bg)] h-32" />,
  },
);
      ...
      <div className="animate-in fade-in slide-in-from-bottom-8 duration-700 flex flex-col gap-8">
        <ErrorBoundary name="ResultSection">
          <ResultSection
            ...
            improvementDelta={
              previousScore !== null && iterationCount > 0
