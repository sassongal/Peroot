  ...
  return (
    <>
      ...
      <div
        ...
        className="fixed inset-x-0 bottom-0 z-60 md:hidden max-h-[min(90dvh,100vh)] flex flex-col rounded-t-3xl bg-white/95 dark:bg-black/95 backdrop-blur-xl border-t border-(--glass-border) animate-in slide-in-from-bottom-4 duration-300 pb-[env(safe-area-inset-bottom,0px)]"
      >
