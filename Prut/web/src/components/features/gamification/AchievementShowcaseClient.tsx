                        ...
                        <div 
                            ...
                            className={cn(
                                ...
                                isUnlocked 
                                    ...
                                    : "bg-[var(--glass-bg)] border-[var(--glass-border)] text-zinc-700 grayscale"
                            )}
                        >
                            {isUnlocked ? (
                            ...
                            {/* Tooltip */}
                            <div className="absolute bottom-full mb-3 left-1/2 -translate-x-1/2 w-48 p-4 rounded-2xl glass-card border border-[var(--glass-border)] bg-zinc-950 shadow-2xl opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none z-50 translate-y-2 group-hover:translate-y-0">
                                <div className="text-xs font-black text-[var(--text-primary)] mb-1">{ach.name_he}</div>
