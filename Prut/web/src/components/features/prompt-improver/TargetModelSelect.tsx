...
const OPTIONS: {
...
}[] = [
  {
    ...
    labelHe: "כללי",
    sub: "מותאם לכל מודל",
    triggerClass: "border-zinc-200/80 bg-zinc-50/90 dark:border-zinc-600 dark:bg-zinc-800/90",
    rowClass: "hover:bg-zinc-100/90 dark:hover:bg-zinc-800/80 border-zinc-100 dark:border-zinc-800",
  ...
  },
  {
    ...
    rowClass: "hover:bg-emerald-500/10 border-emerald-500/10 dark:border-emerald-500/15",
  ...
  },
  {
    ...
    rowClass: "hover:bg-orange-500/10 border-orange-500/10 dark:border-orange-500/15",
  ...
  },
  {
    ...
    rowClass: "hover:bg-blue-500/10 border-blue-500/10 dark:border-blue-500/15",
              ...
              >
                {opt.logoSrc ? (
                  <Image
                    ...
                    width={24}
                    height={24}
                    className={cn("object-contain", opt.value === "claude" && "dark:invert")}
                  />
                ) : (
    ...
    <div ref={rootRef} className="relative" dir="rtl">
      ...
      >
        <span className="shrink-0 w-7 h-7 rounded-lg flex items-center justify-center bg-white/80 dark:bg-black/30 border border-black/5 dark:border-white/10">
          {current.logoSrc ? (
            <Image
              ...
              width={22}
              height={22}
              className={cn("object-contain", current.value === "claude" && "dark:invert")}
            />
          ) : (
        ...
        <span className="flex flex-col min-w-0 leading-snug gap-0.5">
          ...
          <span className="hidden sm:block truncate text-xs text-(--text-muted) font-normal">
            {current.sub}
          </span>
        </span>
        <ChevronDown
