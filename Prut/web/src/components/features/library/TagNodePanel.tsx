...
export function TagNodePanel({
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div
        className="fixed top-0 start-0 h-full w-full max-w-[340px] z-[150] flex flex-col bg-white dark:bg-slate-950 border-e border-slate-200/60 dark:border-white/10 shadow-2xl animate-in slide-in-from-right duration-200"
        dir="rtl"
        role="dialog"
