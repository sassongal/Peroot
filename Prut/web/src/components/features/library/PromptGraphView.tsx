    ...
    <div className="relative w-full flex-1 min-h-[500px] rounded-2xl overflow-hidden border border-slate-200/50 dark:border-white/10 flex flex-col">
      ...
      {!bannerDismissed && (
        ...
        >
          ...
          <button
            ...
            className="p-1 shrink-0 text-slate-400 hover:text-slate-700 dark:hover:text-(--text-primary) rounded transition-colors"
      ...
      >
            ...
            <div className="relative flex-1">
              ...
              {searchQuery && (
                <button
                  ...
                  className="absolute left-1.5 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-700 dark:hover:text-(--text-primary)"
          ...
          <div className="flex items-center gap-1.5 overflow-x-auto scrollbar-none flex-nowrap">
            ...
            {activeInsightFilters.size > 0 && (
              <button
                ...
                className="flex items-center gap-1 px-2.5 py-1 rounded-full border border-slate-300 dark:border-white/15 bg-slate-100 dark:bg-white/8 text-[11px] text-slate-500 dark:text-slate-300 hover:text-slate-800 dark:hover:text-(--text-primary) transition-colors cursor-pointer shrink-0"
              >
                <X className="w-3 h-3" />
                <span>נקה</span>
              </button>
        ...
        <button
          ...
          className="md:hidden absolute bottom-4 left-4 z-20 flex items-center gap-1.5 bg-white/85 dark:bg-black/75 backdrop-blur-md text-slate-700 dark:text-slate-200 text-[11px] px-3 py-2 rounded-full border border-slate-200/60 dark:border-white/15 shadow-lg transition-colors"
          aria-label="מקרא"
        ...
        {selectedPrompt && (
          ...
          >
            <div
              className="relative w-full max-w-2xl max-h-[88vh] md:max-h-[82vh] rounded-2xl border border-(--glass-border) bg-(--surface-panel)/95 shadow-2xl [overflow:clip] flex flex-col animate-in zoom-in-95 duration-200"
