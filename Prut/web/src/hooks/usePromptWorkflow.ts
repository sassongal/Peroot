...
export interface PromptState {
  ...
  /** True while the background /api/enhance/questions call is in flight */
  ...
  switch (action.type) {
    ...
    case "SET_CAPABILITY":
      if (typeof window !== "undefined") {
        ...
        try {
          localStorage.setItem("peroot_last_mode", action.payload);
        } catch (e) {
          logger.warn("[usePromptWorkflow] localStorage write failed:", e);
        }
      }
