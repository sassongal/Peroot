      ...
      <div className="flex" style={{ height: 180 }}>
        <div className="w-28 bg-secondary/60 border-l border-border p-2 shrink-0 space-y-0.5">
          {folders.map((f, i) => (
            <div
              key={f}
              className={`flex items-center gap-1.5 px-2 py-1 rounded cursor-pointer transition-colors ${i === 0 ? "bg-amber-500/20 text-amber-600 dark:text-amber-400 font-medium" : "text-muted-foreground hover:text-foreground"}`}
            >
        ...
        <div className="flex-1 p-2 space-y-1.5 overflow-hidden">
          ...
          <div className="flex items-center gap-1 mt-2 text-muted-foreground/60">
            <span className="text-[10px]">+ 9 פרומפטים נוספים</span>
          </div>
        </div>
      </div>
    </div>
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="space-y-1.5">
          {[
            ...
            { key: "נושא", val: "בינה מלאכותית בתחום ה-HR", color: "text-amber-400" },
...
function SmartImproveMockup() {
  const suggestions = [
    ...
    { text: "ציין את הטון הרצוי (מקצועי / ידידותי)", color: "text-amber-400", bg: "bg-amber-500/10 border-amber-500/20" },
...
const WALKTHROUGH = [
  {
    ...
    accentBadge: "bg-sky-500/20 text-sky-400",
  ...
  },
  {
    ...
    accentBadge: "bg-purple-500/20 text-purple-400",
  ...
  },
  {
    ...
    accentBadge: "bg-emerald-500/20 text-emerald-400",
  ...
  },
  {
    ...
    accentBadge: "bg-amber-500/20 text-amber-400",
  ...
  },
  {
    ...
    accentBadge: "bg-rose-500/20 text-rose-400",
  ...
  },
  {
    ...
    accentBadge: "bg-indigo-500/20 text-indigo-400",
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-8 pb-24">
          ...
          <section className="py-16 md:py-24">
            ...
            <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
              {[
                ...
                <div key={s.label} className="rounded-2xl border border-border bg-secondary/50 p-4 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {WORK_MODES.map((m, i) => {
                ...
                return (
                  <div
                    key={m.subtitle}
                    className={`relative group rounded-2xl border ${m.border} bg-linear-to-b ${m.gradient} p-6 transition-all hover:scale-[1.01] hover:shadow-lg hover:shadow-black/20`}
                  >
                    ...
                    <div className="flex flex-col gap-4">
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {m.platforms.map((p) => (
                          <span key={p} className="text-[11px] px-2.5 py-0.5 rounded-full bg-secondary border border-border text-muted-foreground">
                            {p}
                          </span>
                        ))}
                      </div>
          ...
          <section className="pb-20 space-y-10">
            ...
            <div className="relative grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={s.step} className={`relative rounded-2xl border ${s.bg} p-6 text-center`}>
          ...
          <section className="py-16 text-center space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link
                href="/"
                className="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-2xl bg-linear-to-r from-amber-500 to-yellow-500 text-black font-bold text-sm transition-all hover:scale-[1.03] active:scale-[0.98] shadow-lg shadow-amber-500/25"
              >
