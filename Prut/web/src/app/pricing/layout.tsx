...
export const metadata: Metadata = {
  ...
  description:
    "השוו בין התוכניות של פירוט: חינם עם 2 קרדיטים ביום או Pro עם 150 קרדיטים בחודש. שדרוג פרומפטים וטקסטים בעברית עם AI. יום ניסיון במתנה לתוכנית Pro.",
    ...
    <>
        ...
        data={faqSchema([
          {
            ...
            answer:
              "Peroot מציע תוכנית חינמית עם 2 קרדיטים ביום, ותוכנית Pro עם 150 קרדיטים בחודש. יש יום ניסיון במתנה ל-Pro.",
          },
          {
            question: "מה ההבדל בין חינם ל-Pro?",
            answer:
              "התוכנית החינמית כוללת 2 קרדיטים ביום ומודלים בסיסיים. Pro כוללת 150 קרדיטים בחודש, מודלים פרימיום, שיפור איטרטיבי, וספריה אישית ללא הגבלה.",
          },
          {
            question: "איך מערכת הקרדיטים עובדת?",
            answer:
              "כל שדרוג פרומפט עולה קרדיט אחד. בחינם מקבלים 2 קרדיטים שמתחדשים כל יום ב-14:00. ב-Pro מקבלים 150 קרדיטים שמתחדשים בתחילת כל חודש חיוב.",
          },
          {
      ...
      <div className="sr-only" aria-hidden="false">
        ...
        <section>
          ...
          <p>
            Peroot מציע שתי תוכניות: חינם ו-Pro. התוכנית החינמית כוללת 2 קרדיטים ביום שמתחדשים
            אוטומטית בכל יום ב-14:00, גישה לספריית פרומפטים עם מעל 410 תבניות מקצועיות, אפשרות
            שיתוף, ותוסף Chrome לשדרוג מהיר מכל אתר. תוכנית Pro כוללת יום ניסיון במתנה ו-150 קרדיטים
            בחודש, גישה לכל המנועים המתקדמים, שיפור איטרטיבי מתקדם, ספריה אישית ומועדפים ללא הגבלה,
            תוסף Chrome עם סנכרון מלא לאתר, ותמיכה בעדיפות. כל שדרוג פרומפט עולה קרדיט אחד. ניתן
            לבטל בכל עת ללא התחייבות. התשלום מאובטח דרך Lemon Squeezy.
          </p>
        </section>
        <section>
          <h2>תוכנית חינם</h2>
        ...
        <section>
          ...
          <p>
            כל שדרוג פרומפט ב-Peroot עולה קרדיט אחד. משתמשי חינם מקבלים 2 קרדיטים שמתחדשים כל יום.
