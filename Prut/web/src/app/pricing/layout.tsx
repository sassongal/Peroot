...
export const metadata: Metadata = {
  ...
  description: "השוו בין התוכניות של פירוט: חינם עם 2 קרדיטים ביום או Pro עם 150 קרדיטים בחודש. שדרוג פרומפטים וטקסטים בעברית עם AI. יום ניסיון במתנה לתוכנית Pro.",
...
export default function PricingLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      <JsonLd
        data={faqSchema([
          { question: "כמה עולה Peroot?", answer: "Peroot מציע תוכנית חינמית עם 2 קרדיטים ביום, ותוכנית Pro עם 150 קרדיטים בחודש. יש יום ניסיון במתנה ל-Pro." },
      ...
      <div className="sr-only" aria-hidden="false">
        ...
        <section>
          ...
          <p>
            ...
            תוכנית Pro כוללת יום ניסיון במתנה ו-150 קרדיטים בחודש,
