...
export const metadata: Metadata = {
  ...
  description: "השוו בין התוכניות של פירוט: חינם עם 2 קרדיטים ביום או Pro עם 150 קרדיטים בחודש. שדרוג פרומפטים וטקסטים בעברית עם AI. יום ניסיון במתנה, רק ₪3.99/חודש.",
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            faqSchema([
              { question: "כמה עולה Peroot?", answer: "Peroot מציע תוכנית חינמית עם 2 קרדיטים ביום, ותוכנית Pro ב-3.99 שקלים בחודש עם 150 קרדיטים. יש יום ניסיון במתנה ל-Pro." },
      ...
      <div className="sr-only" aria-hidden="false">
        ...
        <section>
          ...
          <p>
            ...
            תוכנית Pro עולה 3.99 שקלים בחודש עם יום ניסיון במתנה וכוללת 150 קרדיטים בחודש,
