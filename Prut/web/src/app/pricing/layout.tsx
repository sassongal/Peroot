...
export const metadata: Metadata = {
  ...
  description: "השוו בין התוכניות של פירוט: חינם עם 2 קרדיטים ביום או Pro עם 150 קרדיטים בחודש. שדרוג פרומפטים וטקסטים בעברית עם AI. מבצע השקה: רק ₪3.99/חודש במקום ₪16!",
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            faqSchema([
              { question: "כמה עולה Peroot?", answer: "Peroot מציע תוכנית חינמית עם 2 קרדיטים ביום, ותוכנית Pro במבצע השקה - רק 3.99 שקלים בחודש במקום 16 שקלים, עם 150 קרדיטים. יש יום ניסיון במתנה ל-Pro." },
      ...
      <div className="sr-only" aria-hidden="false">
        ...
        <section>
          ...
          <p>
            ...
            תוכנית Pro במבצע השקה עולה רק 3.99 שקלים בחודש במקום 16 שקלים, עם יום ניסיון במתנה וכוללת 150 קרדיטים בחודש,
        ...
        <section>
          ...
          <p>מחיר: מבצע השקה ₪3.99 לחודש (במקום ₪16), יום ניסיון במתנה</p>
        </section>
        <section>
