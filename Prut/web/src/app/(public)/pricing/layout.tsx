      ...
      <div className="sr-only" aria-hidden="false">
        ...
        <section>
          ...
          <p>
            ...
            ספרייה אישית ומועדפים ללא הגבלה, כל המצבים גם בתוסף Chrome, ותמיכה אישית במייל. כל שדרוג
            פרומפט עולה קרדיט אחד. ניתן לבטל בכל עת ללא התחייבות. התשלום מאובטח דרך Lemon Squeezy.
          </p>
        </section>
        <section>
          <h2>תוכנית חינם</h2>
        ...
        <section>
          ...
          <ul>
            ...
            <li>כל המצבים גם בתוסף Chrome</li>
            <li>תמיכה אישית במייל, מענה תוך יום עסקים</li>
          </ul>
