      ...
      <JsonLd
        data={faqSchema([
          ...
          },
          {
            ...
            answer: `התוכנית החינמית כוללת ${freeDailyPhrase}, ארבע שפות פלט, צירוף קבצים, ספרייה אישית עם זיכרון AI ותוסף Chrome. Pro מוסיפה ${proCredits} בחודש בלי מכסה יומית, את המצבים המתקדמים (מחקר, תמונה, וידאו, סוכן) גם בתוסף, העתקה בלי חתימה ותמיכה אישית.`,
          },
          {
      ...
      <div className="sr-only" aria-hidden="false">
        ...
        <section>
          ...
          <p>
            ...
            תבניות מקצועיות, ארבע שפות פלט, צירוף קבצים וקישורים, ספרייה אישית עם זיכרון AI, שיתוף
            ותוסף Chrome. תוכנית Pro כוללת יום ניסיון במתנה ו{proCredits} בחודש בלי מכסה יומית, את
            כל המצבים (מחקר מעמיק, תמונה, וידאו וסוכנים) גם בתוסף Chrome, העתקה בלי חתימת Peroot
            ותמיכה אישית במייל. כל שדרוג פרומפט עולה קרדיט אחד. ניתן לבטל בכל עת ללא התחייבות.
