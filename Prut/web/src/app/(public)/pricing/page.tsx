...
const COMPARISON_FEATURES = [
  {
    ...
    free: "{freeDaily} ביום",
    pro: `${PRO_MONTHLY_CREDITS} בחודש, בלי מכסה יומית`,
    icon: Sparkles,
  },
  {
    name: "מצבי עבודה",
    free: "רגיל",
    pro: "רגיל, מחקר, תמונה, וידאו, סוכן",
    icon: Zap,
  },
  {
    name: "שאלות דיוק ושיפור בצ'יפ אחד",
    free: true,
    pro: true,
    icon: RefreshCw,
  },
  {
    name: "ארבע שפות פלט: עברית, אנגלית, ערבית, רוסית",
    free: true,
    pro: true,
    icon: Bot,
  },
  {
    name: "צירוף קבצים, תמונות וקישורים",
    free: true,
    pro: true,
    icon: Library,
  },
  {
    name: `ספריית ${PROMPT_LIBRARY_COUNT} פרומפטים ותבניות`,
    free: true,
    pro: true,
    icon: Library,
  },
  {
    name: "ספרייה אישית: תיקיות, תגיות, מועדפים, גרף קשרים",
    free: true,
    pro: true,
    icon: Library,
  },
  {
    name: "זיכרון AI ופרופיל סגנון אישי",
    free: true,
    pro: true,
    icon: Brain,
  },
  {
    name: "שיגור ישיר ל-ChatGPT, Claude ו-Gemini, שיתוף בקישור",
    free: true,
    pro: true,
    icon: Zap,
  },
  {
    name: "תוסף Chrome בתוך הצ'אט",
    free: true,
    pro: true,
    icon: Chrome,
  },
  {
    name: "כל המצבים גם בתוסף Chrome",
    free: false,
    pro: true,
    icon: Chrome,
  },
  {
    name: "העתקה בלי חתימת Peroot",
    free: false,
    pro: true,
    icon: Crown,
  },
  {
    name: "תמיכה אישית במייל, מענה תוך יום עסקים",
    free: false,
    pro: true,
    icon: Headphones,
  },
