    ...
    params: [
      {
        name: "--ar",
        values: "רוחב:גובה",
        description: "יחס גובה-רוחב, 16:9 לנוף, 9:16 לפורטרט, 1:1 לסושיאל, 3:2 לצילום",
      },
      {
        name: "--s (stylize)",
        values: "0-1000",
        description: "כמה Midjourney מוסיף סגנון משלו, 0 צמוד לפרומפט, 1000 אמנותי מאוד",
      },
      {
        name: "--chaos",
        values: "0-100",
        description: "מגוון בתוצאות, 0 תוצאות דומות, 100 תוצאות מפתיעות ושונות",
      },
      {
        name: "--no",
        values: "רשימת מילים",
        description: "שלילה: מה לא לכלול בתמונה: --no text, watermark, people",
      },
      {
        name: "--raw",
        values: "דגל",
        description: "מפחית את ההתערבות האמנותית של Midjourney: תוצאה גולמית יותר, פחות 'מלוטשת'",
      },
      {
        name: "--oref / --ow",
        values: "מזהה תמונה / 0-1000",
        description: "Object reference: שמירה על עקביות אובייקט ספציפי בין תמונות. --ow קובע עוצמה",
      },
      {
        name: "--sref / --sw",
        values: "מזהה תמונה / 0-1000",
        description: "Style reference: שמירה על סגנון ויזואלי עקבי. --sw קובע עוצמה",
      },
      {
        name: "--draft",
        values: "דגל",
        description: "מצב טיוטה מהיר, 2-3 שניות במקום 30-60. מושלם לאיטרציה",
      },
      {
        name: "--personalize",
        values: "דגל",
        description: "התאמה לטעם האישי שלך על סמך דירוגים קודמים",
      },
      {
        name: "--quality",
        values: "1 / 2 / 4",
        description: "זמן עיבוד, 1 רגיל, 2 כפול, 4 פי ארבע. quality 4 לתוצאות בהן כל פיקסל חשוב",
      },
    ],
    ...
    params: [
      {
        ...
        description: "איכות הפלט, low מהיר, high מפורט ואיטי יותר",
      },
      {
        name: "size",
        values: "1024x1024 / 1792x1024 / 1024x1792",
        description: "ממדי התמונה: ריבוע, אופקי, או אנכי",
      },
      {
        name: "background",
        values: "auto / transparent",
        description: "רקע שקוף: מושלם ללוגואים ואלמנטים גרפיים",
      },
    ],
...
<p><strong>חשוב:</strong> אין negative prompts ב-FLUX. אם אתה לא רוצה משהו: פשוט אל תכתוב אותו. במקום 'no watermark': אל תזכיר watermark כלל.</p>`,
    ...
    params: [
      {
        name: "Resolution",
        values: "מכפלות של 16, עד 4MP",
        description: "1024x1024 / 1360x768 / 1024x1792: חייב כפולות של 16",
      },
      {
        name: "Model",
        values: "schnell / dev / pro",
        description: "schnell מהיר (1-2s), dev מאוזן (5-10s), pro איכות מקסימלית (20-30s)",
      },
      {
        name: "Guidance scale",
        values: "1.0-5.0",
        description: "כמה צמוד לפרומפט, 2.5-3.5 אידיאלי. מעל 5 גורם לאובר-סאטורציה",
      },
      {
        name: "Steps",
        values: "20-50",
        description: "מספר שלבי דיפוזיה, 25-30 מאוזן, 50 לפרטים מקסימליים",
      },
    ],
...
<p><strong>ההבדל הקריטי:</strong> ב-SDXL, CFG 7-9. ב-SD3.5, CFG 3.5-4.5. שימוש ב-CFG 7 על SD3.5 ייצר אובר-סאטורציה והפרזה.</p>`,
    ...
    params: [
      {
        name: "CFG Scale",
        values: "SDXL: 7-9 / SD3.5: 3.5-4.5",
        description: "כמה צמוד לפרומפט: ערך שונה לכל מודל!",
      },
      {
        name: "Sampler",
        values: "DPM++ 2M Karras / Euler / UniPC",
        description: "אלגוריתם דגימה: משפיע על טקסטורה ופרטים",
      },
      {
        name: "Steps",
        values: "20-50",
        description: "שלבי דיפוזיה, 25-30 ברוב המקרים, 50 לפרטים מקסימליים",
      },
      {
        name: "Negative prompt",
        values: "טקסט חופשי",
        description: "SDXL: מפורט (10-20 פריטים). SD3.5: מינימלי (3-5)",
      },
      {
        name: "Weight syntax",
        values: "(word:0.5-1.5)",
        description: "SDXL בלבד: משקל לכל מילה. 1.0 = רגיל, 1.3 = חזק",
      },
      {
        name: "Resolution",
        values: "1024x1024 / 1344x768 / 768x1344",
        description: "SDXL תומך ברזולוציות שונות. 1024x1024 ברירת מחדל",
      },
    ],
    ...
    params: [
      {
        name: "Resolution",
        values: "עד 2K (2048px)",
        description: "רזולוציה מקורית 2K: ללא upscale, פרטים חדים",
      },
      {
        name: "[exclude]",
        values: "רשימת פריטים",
        description: "שלילה, [exclude: watermark, text, people]. 5-8 פריטים מקסימום",
      },
      {
        name: "Aspect ratio",
        values: "1:1 / 16:9 / 9:16 / 4:3 / 3:4",
        description: "יחס גובה-רוחב: תלוי בשימוש",
      },
    ],
...
<p><strong>שגיאה נפוצה:</strong> imageSize חייב להיות CASE SENSITIVE, "1K" ולא "1k"!</p>`,
    ...
    params: [
      {
        name: "imageSize",
        values: "1K / 2K (CASE SENSITIVE!)",
        description: "גודל תמונה: חייב אותיות גדולות! '1K' ולא '1k'",
      },
      {
        name: "Character refs",
        values: "עד 5 דמויות",
        description: "תמונות ייחוס לשמירת עקביות דמויות",
      },
      {
        name: "Reference images",
        values: "עד 14 תמונות",
        description: "תמונות ייחוס לסגנון, סביבה, ודמויות",
      },
    ],
   ...
   * ────────────────────────────────────────────── */
  {
    ...
    metaTitle: "מדריך יצירת תמונות AI: ארכיטקטורת 7 שכבות, השוואה וטיפים | Peroot",
    metaDescription:
