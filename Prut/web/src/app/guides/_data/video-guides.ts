    ...
    params: [
      {
        name: "Duration",
        values: "5s / 10s",
        description: "משך הסרטון, 5 שניות לתנועות פשוטות, 10 שניות לסצנות מורכבות",
      },
      {
        name: "Aspect Ratio",
        values: "16:9 / 9:16 / 1:1",
        description: "יחס גובה-רוחב, 16:9 לקולנועי, 9:16 לריילס, 1:1 לסושיאל",
      },
      {
        name: "Mode",
        values: "Standard / Director",
        description: "Standard למהירות, Director לשליטה מלאה בתנועת מצלמה",
      },
      {
        name: "Model",
        values: "Gen-4 / Gen-4 Turbo",
        description: "Turbo מהיר יותר לאיטרציות, Standard לאיכות מקסימלית",
      },
    ],
    ...
    params: [
      {
        name: "Duration",
        values: "3s-15s",
        description: "משך גמיש, 3s לתנועות קצרות, 10-15s לסצנות מורכבות",
      },
      {
        name: "Resolution",
        values: "720p / 1080p / 4K",
        description: "4K מקורי: השתמש ל-hero shots, 1080p לעבודה יומיומית",
      },
      {
        name: "Mode",
        values: "Standard / Pro",
        description: "Pro לאיכות מקסימלית ופיזיקה מדויקת יותר",
      },
      {
        name: "Motion Brush",
        values: "On / Off",
        description: "סימון אזורי תנועה ידני: שליטה מלאה בתנועה סלקטיבית",
      },
      {
        name: "Negative Prompt",
        values: "טקסט חופשי",
        description: "3-7 פריטים מקסימום: מה לא לכלול בתוצאה",
      },
    ],
...
<p>טיפ חשוב: הגדר <strong>3-5 עוגני צבע</strong> (color anchors) כדי לשמור על פלטת צבעים עקבית. למשל: "Color palette: warm amber, deep burgundy, smoke gray."</p>`,
    ...
    params: [
      {
        name: "Duration",
        values: "4 / 8 / 12 / 16 / 20 שניות",
        description: "משכים קבועים: בחר לפי מורכבות הסצנה",
      },
      {
        name: "Resolution",
        values: "720p (sora-2) / 1080p (sora-2-pro)",
        description: "sora-2-pro לאיכות מקסימלית",
      },
      {
        name: "Character Ref",
        values: "תמונת ייחוס",
        description: "שמירה על עקביות דמות בין סרטונים",
      },
    ],
...
<p><strong>חשוב:</strong> כל אחד מ-4 רכיבי האודיו צריך להיות במשפט נפרד. Veo מפרסר את זה טוב יותר כשכל ערוץ מופרד.</p>`,
    ...
    params: [
      {
        name: "Duration",
        values: "4 / 6 / 8 שניות",
        description: "4-6 שניות לדיאלוג, 8 שניות לסצנות ויזואליות",
      },
      {
        name: "Resolution",
        values: "1080p / 4K",
        description: "1080p לעבודה יומיומית, 4K לתוצאה סופית",
      },
      {
        name: "Ingredients",
        values: "עד 4 תמונות ייחוס",
        description: "Ingredients to Video: תמונות שמנחות את הסצנה",
      },
    ],
   ...
   * ────────────────────────────────────────────── */
  {
    ...
    metaTitle: "מדריך פרומפטים ל-Minimax Hailuo 2.3: כוריאוגרפיה, [מצלמה] וטיפים | Peroot",
    metaDescription:
...
<p><strong>כלל הזהב:</strong> ככל שתתאר יותר ניואנסים רגשיים בהבעות הפנים, התוצאה תהיה מרשימה יותר. Minimax הוא הפלטפורמה שמשתלם בה הכי הרבה לכתוב פרטי הבעה.</p>`,
    ...
    params: [
      {
        name: "Duration",
        values: "6s (1080p) / 10s (768p)",
        description: "6 שניות באיכות מלאה, 10 שניות ברזולוציה מופחתת",
      },
      {
        name: "Resolution",
        values: "1080p / 768p",
        description: "1080p ל-6 שניות בלבד, 768p לעד 10 שניות",
      },
      {
        name: "[Camera]",
        values: "סינטקס סוגריים",
        description: "עד 3 תנועות מצלמה בסוגריים מרובעים",
      },
    ],
   ...
   * ────────────────────────────────────────────── */
  {
    ...
    metaTitle: "מדריך יצירת סרטוני AI: ארכיטקטורת 7 שכבות, השוואה וטיפים | Peroot",
    metaDescription:
