...
function SectionHeading({ id, children }: { id: string; children: React.ReactNode }) {
  return (
    <h2 id={id} className="text-2xl md:text-3xl font-serif text-foreground mb-2 scroll-mt-24">
      {children}
...
export default function GuidePage() {
  return (
    <>
      ...
      />
      <JsonLd
        data={speakablePageSchema(`${_SITE}/guide`, ["h1", "h2", ".glass-card p", "details p"])}
      />
      <JsonLd
        data={{
          ...
          description:
            "למדו איך לכתוב פרומפטים מקצועיים שמפיקים תוצאות מדויקות מ-ChatGPT, Claude, Gemini ו-Midjourney",
          author: {
            "@type": "Person",
            name: "Gal Sasson",
          ...
          <div className="lg:flex lg:gap-10">
            ...
            <div className="flex-1 max-w-4xl">
                  ...
                  <GlassCard className="p-4 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-muted-foreground">
                        ({TABLE_OF_CONTENTS.length} פרקים)
                      </span>
                    </div>
              ...
              <section className="mb-16 space-y-8">
                ...
                {GOLDEN_RULES.map((rule, i) => {
                  ...
                  return (
                    <GlassCard
                      key={i}
                      className="p-6 md:p-8 bg-linear-to-br from-amber-500/3 to-transparent"
                    >
              ...
              <section className="mb-16 space-y-8">
                ...
                <p className="text-muted-foreground text-base leading-relaxed">
                  אחרי שתשלוט בעקרונות הבסיסיים, הטכניקות האלה יאפשרו לך לחלץ ביצועים ברמה גבוהה עוד
                  יותר ממודלי AI.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {ADVANCED_TECHNIQUES.map((tech, i) => (
                    <GlassCard
                      key={i}
                      className="p-6 space-y-4 bg-linear-to-br from-blue-500/3 to-transparent"
                    >
              ...
              <section className="mb-16 space-y-8">
                ...
                <GlassCard className="p-6 md:p-8 space-y-6 bg-linear-to-br from-emerald-500/3 to-transparent">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-lg font-serif text-foreground">
                        מבנה System Prompt לסוכן
                      </h3>
                      <p className="text-xs text-muted-foreground mt-0.5">
                        הגדרת תפקיד, מגבלות, סגנון ותהליך
                      </p>
                    </div>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="border border-emerald-500/15 bg-emerald-950/10 rounded-xl p-4 space-y-2">
                      ...
                      <ul className="text-sm text-muted-foreground space-y-1.5 leading-relaxed">
                        ...
                        <li className="flex gap-2">
                          <CheckCircle className="w-3.5 h-3.5 text-emerald-400 mt-1 shrink-0" />
                          סגנון תקשורת (שפה, טון, אורך)
                        </li>
                        <li className="flex gap-2">
                          <CheckCircle className="w-3.5 h-3.5 text-emerald-400 mt-1 shrink-0" />
                          תהליך עבודה שלב-אחרי-שלב
                        </li>
                      </ul>
                    </div>
                    <div className="border border-red-500/15 bg-red-950/10 rounded-xl p-4 space-y-2">
                      ...
                      <ul className="text-sm text-muted-foreground space-y-1.5 leading-relaxed">
                        <li className="flex gap-2">
                          ...
                          הנחיות מעורפלות (&ldquo;היה טוב&rdquo;)
                        </li>
                        <li className="flex gap-2">
                          <XCircle className="w-3.5 h-3.5 text-red-400 mt-1 shrink-0" />
                        ...
                        <li className="flex gap-2">
                          <XCircle className="w-3.5 h-3.5 text-red-400 mt-1 shrink-0" />
                          אישיות סותרת (מקצועי + קזואלי)
                        </li>
                        <li className="flex gap-2">
                          <XCircle className="w-3.5 h-3.5 text-red-400 mt-1 shrink-0" />
                          חוסר guardrails למקרי קצה
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <GlassCard className="p-6 md:p-8 space-y-6 bg-linear-to-br from-cyan-500/3 to-transparent">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-0.5">
                        היקף + מיקוד + מבנה פלט + דרישת מקורות
                      </p>
                    </div>
                  </div>
              ...
              <section className="mb-16 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {PLATFORMS.map((platform) => (
                    <GlassCard
                      key={platform.name}
                      className={`p-6 bg-linear-to-br ${platform.color}`}
                    >
                      ...
                      <ul className="space-y-3">
                        {platform.tips.map((tip, j) => (
                          <li
                            key={j}
                            className="flex gap-2 text-sm text-secondary-foreground leading-relaxed"
                          >
                            <ChevronRight
                              className={`w-4 h-4 shrink-0 mt-0.5 ${platform.dot.replace("bg-", "text-")}`}
                            />
                            <span>{tip}</span>
                          </li>
                        ))}
              ...
              <section className="mb-16 space-y-8">
                ...
                <p className="text-muted-foreground text-base leading-relaxed">
                  העולם של AI ב-2026 שונה מהותית מ-2024. הנה מה שהשתנה ואיך להתאים את הפרומפטים
                  שלכם.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {TIPS_2026.map((tip, i) => {
                    ...
                    return (
                      <GlassCard
                        key={i}
                        className="p-5 bg-linear-to-br from-amber-500/3 to-transparent"
                      >
              ...
              <section className="mt-8 mb-8 grid grid-cols-1 sm:grid-cols-3 gap-3">
                <CrossLinkCard
                  ...
                  description={`${PROMPT_LIBRARY_COUNT} פרומפטים מוכנים לשימוש מיידי`}
                />
                <CrossLinkCard
                  href="/features"
                  title="כל היכולות של המערכת"
                  description="5 מנועי AI, תמונות, סרטונים וסוכנים"
                />
                <CrossLinkCard
                  href="/pricing"
                  title="שדרגו לתוכנית מתקדמת"
                  description="150 קרדיטים בחודש ומודלים פרימיום"
                />
              </section>
            </div>
          </div>
