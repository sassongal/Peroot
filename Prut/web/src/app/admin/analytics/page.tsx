...
export default function AnalyticsPage() {
  ...
  const loadAnalytics = useCallback(async () => {
    ...
    try {
      ...
      // Fetch product data from Supabase + GA4 traffic in parallel
      ...
      <div className="space-y-8 animate-in fade-in duration-700 pb-20" dir="rtl">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-2">
            <h1 className="text-4xl md:text-5xl font-black bg-gradient-to-r from-white to-slate-500 bg-clip-text text-transparent tracking-tighter">
              Growth Analytics
            </h1>
            <p className="text-slate-400 font-medium tracking-wide text-sm">ניתוח מעמיק של ביצועי המערכת, צמיחה ומעורבות</p>
          </div>
