      ...
      <div className="space-y-10 animate-in fade-in duration-700 pb-20" dir="rtl">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-2">
            ...
            <p className="text-slate-400 font-medium tracking-wide">
              ניהול פרמטרים גלובליים, עיצוב ומודל עסקי
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <SectionContainer icon={Zap} title="כלכלה ומגבלות" color="amber">
            ...
            {/* registration_bonus deprecated 2026-04-24: new users now get daily_free_limit only.
                The DB column still exists and is set to 0 for all existing rows. */}
          </SectionContainer>
    ...
    <div className="rounded-[32px] border border-white/10 bg-zinc-900/30 backdrop-blur-xl overflow-hidden shadow-2xl group transition-all duration-500 hover:border-white/20">
      <div className="p-8 space-y-6">
        <div className="flex items-center gap-4 mb-2">
          <div
            className={cn("p-3 rounded-2xl border flex items-center justify-center", colors[color])}
          >
  ...
  return (
    <div className="space-y-2 group/field">
      <div className="flex items-center justify-between">
        <label className="block text-[10px] font-black uppercase tracking-widest text-slate-500 group-focus-within/field:text-blue-400 transition-colors">
          {label}
        </label>
      </div>
      <div className="relative">
        {Icon && (
          <Icon className="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-600 transition-colors group-focus-within/field:text-white" />
        )}
        <input
          type={type}
          value={value}
    ...
    <div className="flex items-center justify-between p-6 bg-black/40 border border-white/5 rounded-[24px] group/toggle hover:bg-black/60 transition-all">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <div className="text-[10px] text-slate-600 font-medium mt-1 leading-relaxed max-w-xs">
            {description}
          </div>
        </div>
      </div>
