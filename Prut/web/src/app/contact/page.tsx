          ...
          <section className="border-t border-border pt-8 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <details className="group bg-secondary border border-border rounded-xl">
                ...
                <div className="px-4 pb-4 text-muted-foreground text-sm leading-relaxed">
                  בתוכנית החינמית, הקרדיטים מתחדשים 24 שעות לאחר השימוש האחרון. בתוכנית Pro, 150
                  הקרדיטים מתחדשים בתחילת כל חודש חיוב. אפשר תמיד לשדרג ל-Pro באמצע חודש ולקבל מיד
                  את מלוא הקרדיטים.
                </div>
              </details>
